-- -----------------------------------------------------
-- Schema online-shop-db
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `online-shop-db`;

CREATE SCHEMA `online-shop-db`;
USE `online-shop-db` ;

-- -----------------------------------------------------
-- Table `online-shop-db`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `online-shop-db`.`product_category` (
...
-- -----------------------------------------------------
-- Table `online-shop-db`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `online-shop-db`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
